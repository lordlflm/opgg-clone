...
pub async fn get_matches_from_puuid(puuid: String, region: String) -> Result<Vec<String>, Error> {
  ...
  let matches_response = reqwest::get(url)
    .await?
    .json::<Vec<String>>()
    .await?;
...
fn get_region_continent(region: &String) -> Result<String, ()> {
  match region.as_str() {
    "north america" | "na1" | "brazil" | "br1" | "LAS" | "la2" | "LAN" | "la1" => Ok("americas".to_string()),
    "korea" | "kr" | "japan" | "jp1" => Ok("asia".to_string()),
    "europe nordic & east" | "eun1" | "europe west" | "euw1" | "russia" | "ru1" | "ru" | "turkiye" | "tr1" | "middle east" | "me1" => Ok("europe".to_string()),
    "oceania" | "oc1" | "oce" | "philippines" | "ph2" | "singapore" | "sg2" | "thailand" | "th2" | "taiwan" | "tw2" | "vietnam" | "vn2" => Ok("sea".to_string()),
    _ => Err(()),
  }
}
